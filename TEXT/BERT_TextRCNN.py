...
class TextRCNNModel(nn.Module):
    def __init__(self, bert_model, hidden_size, num_classes, max_len):
        ...
        self.max_len = max_len
        self.rnn = nn.RNN(bert_model.config.hidden_size, hidden_size, batch_first=True, bidirectional=True)
...
if __name__ == "__main__":
    ...
    model = TextRCNNModel(bert_model, HIDDEN_SIZE, 2, MAX_LEN)
