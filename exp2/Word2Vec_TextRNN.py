...
class TextRNNModel(nn.Module):
    def __init__(self, emb_matrix, max_len, class_num, hidden_num):
        ...
        self.rnn = nn.RNN(input_size=self.emb_num, hidden_size=hidden_num, num_layers=1, batch_first=True)
...
if __name__ == "__main__":
    ...
    model = TextRNNModel(words_embedding, MAX_LEN, CLASS_NUM, HIDDEN_DIM).to(DEVICE)
